...
// TEST 4: Räkna meningar
console.log('TEST 4: Räkna meningar')
...
// TEST 5: Hitta längsta ordet
console.log('TEST 5: Hitta längsta ordet')
...
// TEST 6: Hitta kortaste ordet
console.log('TEST 6: Hitta kortaste ordet')
console.log('Input: "kort medellång längsta"')
...
// TEST 7: Språkdetektering - Svenska
console.log('TEST 7: Språkdetektering - Svenska')
...
// TEST 8: Språkdetektering - Engelska
console.log('TEST 8: Språkdetektering - Engelska')
...
// TEST 9: Extrahera titlar
console.log('TEST 9: Extrahera titlar')
...
// TEST 10: Söka efter ord
console.log('TEST 10: Söka efter ord')
